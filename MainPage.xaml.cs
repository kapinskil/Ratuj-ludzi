    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void playArea_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (humanCapture)
            {
                ...
                Point relativePosition = gird.TransformToVisual(playArea).TransformPoint(pointerPosition);
        ...
        private void human_PointerCanceled(object sender, PointerRoutedEventArgs e)
        {

            ;
        }

        private void human_PointerCanceled_1(object sender, PointerRoutedEventArgs e)
        {
            ;
        }

        private void human_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
            ;
        }

        private void playArea_DoubleTapped(object sender, DoubleTappedRoutedEventArgs e)
        {
            ;
        }
    }
